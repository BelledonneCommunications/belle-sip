		...
		case BELLE_SIP_DIALOG_CONFIRMED:
			...
			if (is_invite){
				...
				if (may_kill_last_transaction && previous_transaction){
					belle_sip_transaction_state_t previous_transaction_state = belle_sip_transaction_get_state(previous_transaction);
					if (belle_sip_transaction_state_is_transient(previous_transaction_state)){
						belle_sip_warning("Forcibly terminating previous transaction in state [%s] as BYE is being [%s].",
