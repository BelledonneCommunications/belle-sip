...
struct belle_sip_channel{
	...
	unsigned char inhibit_input_logging_buffer; /*log buffer for input content only if this is non binary data, and stop it at the first occurence*/
	unsigned char inhibit_output_logging_buffer; /*log buffer for input content only if this is non binary data, and stop it at the first occurence*/
