...
BELLESIP_EXPORT belle_sip_file_body_handler_t *belle_sip_file_body_handler_new(const char *filepath, belle_sip_body_handler_progress_callback_t progress_cb, void *data, belle_sip_body_handler_direction_t direction);
 ...
 * The original purpose of this is to be able to deliver modulo(16) size chunks to the file transfer decryption function
 */
BELLESIP_EXPORT belle_sip_file_body_handler_t *belle_sip_buffering_file_body_handler_new(const char *filepath, const size_t buffer_size, belle_sip_body_handler_progress_callback_t progress_cb, void *data, belle_sip_body_handler_direction_t direction);
