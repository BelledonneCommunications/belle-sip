 ...
 * @param call_if of the dialog
 * @param remote_tag of the dialog
 * @returns dialog that might correspond to these parameters or NULL if not found
 *
 **/
BELLESIP_EXPORT belle_sip_dialog_t* belle_sip_provider_guess_dialog(const belle_sip_provider_t *prov, const char* call_id,const char* remote_tag);
