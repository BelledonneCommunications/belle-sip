...
static void test_simple_session_description(void) {
	...
	BC_ASSERT_STRING_EQUAL(l_raw_session_description, l_src);
	...
	/*belle_sdp_acfg_attribute_t* acfg = belle_sdp_session_description_get_acfg_attribute(l_session_description);
	BC_ASSERT_PTR_NOT_NULL(acfg);
	if (acfg) {
		BC_ASSERT_EQUAL(belle_sdp_acfg_attribute_get_id(acfg), 1, int, "%d");
	}*/
