...
static void dns_fallback_because_resource_temporarily_unavailable(void) {
	const char *nameservers[]={
		"212.245.255.2",
		"8.8.8.8", /* public nameserver, should work*/
		NULL
...
test_t resolver_tests[] = {
	...
	TEST_NO_TAG("DNS fallback because resource temporarily unavailable", dns_fallback_because_resource_temporarily_unavailable),
